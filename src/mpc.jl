function MPC_step(ip::InteractionPlanner, ego_actual_state::Vector{T}, other_actual_state::Vector{T}; ibr_iterations=3::Int64, leader="ego"::String) where {T}
    ...
    _, _, ego_control = IteratedBestresponse(ip, ibr_iterations, leader)
